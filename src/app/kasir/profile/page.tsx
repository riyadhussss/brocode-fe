...
export default function Profile() {
  ...
  const handleConfirmSave = async () => {
    ...
    try {
      ...
      const hasNameChange = formData.name !== currentKasir.name;
      const hasEmailChange = formData.email !== currentKasir.email;
      ...
      if (response.success && response.data) {
        ...
        // Update current kasir data
        setCurrentKasir(updatedProfileData);
